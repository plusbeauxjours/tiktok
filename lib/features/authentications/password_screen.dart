...
import 'package:tiktok/features/authentications/birthday_screen.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: FormButton(
                  disabled:
                      !_isPasswordLengthValid() && !_isPasswordTypesValid(),
                ),
              ),
            ],
          ),
